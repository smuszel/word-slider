...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"Board.jsx":[function(require,module,exports) {
"use strict";
...
var areNeighbours = function areNeighbours(t1, t2) {
  var h = Math.abs(t1.x - t2.x);
  var v = Math.abs(t1.y - t2.y);
  var r = h === 0 && v === 1 || h === 1 && v === 0;
  return r;
};

var Tile = function Tile(_ref) {
  var focused = _ref.focused,
      crossed = _ref.crossed,
      char = _ref.char,
      x = _ref.x,
      y = _ref.y,
      tileid = _ref.tileid,
...
function (_React$Component) {
  ...
  function Board() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "startDrag", function (t) {
      return function () {
        var tileid = t.tileid;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "endDrag", function (ev) {
      _this.setState({
        focusedTile: undefined
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "checkForTileMove", function (ev) {
      var sourceTile = _this.props.tileData.find(function (t) {
        return t.tileid === _this.state.focusedTile;
      });

      var targetTile = _this.props.tileData.find(function (t) {
        return t.tileid === Number.parseInt(ev.target.getAttribute('tileid'));
      });

      var tilesDefined = sourceTile && targetTile;
      var tilesDiffer = tilesDefined && sourceTile !== targetTile;
      var sourceIsWordChar = tilesDiffer && sourceTile.char !== '.';
      var targetIsBlank = tilesDiffer && targetTile.char === '.';
  ...
  _createClass(Board, [{
    ...
    value: function render() {
      ...
      var tiles = this.props.tileData.map(function (t, ix) {
        var focused = t.tileid === _this2.state.focusedTile;
        return _react.default.createElement(Tile, _extends({
          onMouseDown: _this2.startDrag(t),
          key: ix
        }, _objectSpread({}, t, {
          focused: focused
        })));
...
exports.Board = Board;
},{"react":"node_modules/react/index.js"}],"WordList.jsx":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  _createClass(WordList, [{
    key: "render",
    value: function render() {
      var words = this.props.wordList.map(function (w, ix) {
        return _react.default.createElement("div", {
          key: ix,
          className: "word",
...
},{"react":"node_modules/react/index.js"}],"Game.jsx":[function(require,module,exports) {
"use strict";
...
var ixToCoord = function ixToCoord(edge, ix) {
  var x = ix % edge;
  var y = Math.floor(ix / edge);
  return [x, y];
};
...
var transpose = function transpose(array) {
  ...
  var transposed = nArr.map(function (_, i, a) {
    return a[i % n * n + Math.floor(i / n)];
  });
  return transposed;
};

var wordBlocks = function wordBlocks(chars) {
  var prevChar;
  var edge = Math.sqrt(chars.length);
  var temp = [[]];

  for (var index = 0; index < chars.length; index++) {
    var charObj = chars[index];
    var breakBlock = prevChar === '.' || charObj.ix % edge === 0;
    var wordChar = charObj.char !== '.';

    if (wordChar && breakBlock) {
      temp.push([charObj]);
    } else if (wordChar) {
      var lastWordBuild = temp[temp.length - 1];
  ...
  var wordBlocks = temp.map(function (block) {
    return {
      word: block.map(function (c) {
        return c.char;
      }).join(''),
      tileids: block.map(function (c) {
        return c.tileid;
      })
    };
  });
...
function (_React$Component) {
  ...
  _createClass(Game, [{
    ...
    get: function get() {
      ...
      var horizontalWordBlocks = wordBlocks(charsHorizontally);
      ...
      var isCrossed = function isCrossed(word) {
        var rev = word.split('').reverse().join('');

        var normalCross = _this2.props.wordsToCross.includes(word);

        var reverseCross = _this2.props.wordsToCross.includes(rev);

        return normalCross || reverseCross;
      };

      var crossedBlocks = totalWordBlocks.map(function (b) {
        return isCrossed(b.word);
      });
...
exports.Game = Game;
},{"react":"node_modules/react/index.js","./Board":"Board.jsx","./WordList":"WordList.jsx"}],"index.jsx":[function(require,module,exports) {
"use strict";
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./Game":"Game.jsx"}]},{},["index.jsx"], null)
//# sourceMappingURL=/rg.78399e21.map